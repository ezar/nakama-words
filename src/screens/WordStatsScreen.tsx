...
export function WordStatsScreen() {
  ...
  function label(r: typeof rows[0]) {
    if (r.acc < 0.5)  return { text: t.struggling, color: 'text-op-red',   bar: 'bg-op-red' }
    if (r.acc < 0.85) return { text: t.learning,   color: 'text-op-gold',  bar: 'bg-op-gold' }
    return               { text: t.mastered,     color: 'text-op-green', bar: 'bg-op-green' }
  }
