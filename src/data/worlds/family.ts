...
export const familyWorld: World = {
  ...
  words: [
    ...
    { en: 'SON',         es: 'HIJO',       hint: 'A boy child',                     icon: '👦' },
    { en: 'DAUGHTER',    es: 'HIJA',       hint: 'A girl child',                    icon: '👧' },
    { en: 'HUSBAND',     es: 'ESPOSO',     hint: 'A married man',                   icon: '👨' },
    { en: 'WIFE',        es: 'ESPOSA',     hint: 'A married woman',                 icon: '👩' },
    { en: 'FRIEND',      es: 'AMIGO',      hint: 'Someone you like and trust',      icon: '🤝' },
  ],
}
