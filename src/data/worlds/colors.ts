...
export const colorsWorld: World = {
  ...
  words: [
    ...
    { en: 'GRAY',       es: 'GRIS',       hint: 'Color of storm clouds',           icon: '🩶' },
    { en: 'SILVER',     es: 'PLATEADO',   hint: 'Shiny like a mirror',             icon: '🥈' },
    { en: 'GOLD',       es: 'DORADO',     hint: 'Shiny like treasure',             icon: '🥇' },
    { en: 'SKY BLUE',   es: 'CELESTE',    hint: 'Light blue, like a clear sky',    icon: '🌤️' },
    { en: 'TURQUOISE',  es: 'TURQUESA',   hint: 'Blue-green, color of tropical sea', icon: '🩵' },
  ],
}
